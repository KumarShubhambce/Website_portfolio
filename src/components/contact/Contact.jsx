...
const handleSubmit = (e) => {
    ...
    axios.post('https://sheet.best/api/sheets/a7a451ba-a4df-4302-912a-8ea5922c2962' , form).then((response) => {
        console.log(response);
        //clearing form fileds
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">Katihar, Bihar, India</p>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">thekumarofficials@gmail.com</p>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">+91 6205632458</p>
                </div>
            </div>
